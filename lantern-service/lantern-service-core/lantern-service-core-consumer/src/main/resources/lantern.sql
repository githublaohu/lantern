...
(
    ...
    ul_login_ip             int             not null default '' comment '用户登录Ip',
    ...
    ul_quit_ip              int             not null default '' comment '用户登录Ip',
...
(
    ...
    system_id        bigint                                              not null comment '系统id',
    user_id          bigint                                              not null default '' comment '用户id',
...
on urr.urrRoleId = r.roleId inner join  resource_role_relation as rrr on r.roleId = rrr.rrrRoleId inner join  resources as re on rrr.rrr_resource_id = re.resource_id
where re.resource_name = ?
